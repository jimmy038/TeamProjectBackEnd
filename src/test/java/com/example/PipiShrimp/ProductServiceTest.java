...
public class ProductServiceTest {
	...
	public void createTest() {
	    ...
	    Product product1 = new Product(22200, "����", "�隞亦忽�����", null, 100, 25, 0, true, "", 1, currentDate);
	    ...
	    Product product2 = new Product(22, "����", "�靘����", null, 299, 25, 12, true, "", 1, currentDate);
	    ...
	    Product product3 = new Product(3, "憭折獄", "�憌��", null, 3999, 10, 999, false, "", 1, currentDate);
